...
if (!is_null($form))
{
    ...
    <div class="cmApp_signupContainer <?php echo $hasSubHeader?> cmApp_<?php echo $formType ?> cmApp_hidden<?php echo $placementCssClasses; ?>" id="cmApp_signupContainer" style="<?php echo $boxBgStyle; ?>">
        ...
        <div class="cmApp_signupFormWrapper">
            ...
            <form action="<?php echo get_admin_url(); ?>/wp-admin/admin-post.php" method="post" id="cmApp_signupForm" data-uuid="<?php echo htmlDecodeEncode($formId); ?>" class="cmApp_cf cm-form-handler">
